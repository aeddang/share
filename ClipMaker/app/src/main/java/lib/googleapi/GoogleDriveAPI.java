...
public class GoogleDriveAPI {
    ...
    private static GoogleDriveAPI instence;
    ...
    public interface GoogleDriveDelegate
    {
        ...
        void getTokenComplete(String token);
        void getFileListComplete(List<String> result);
    }



	public static GoogleDriveAPI getInstence(){
    ...
    public GoogleDriveAPI(Activity _context) {
    	instence=this;
        context=_context;
        ...
        switch(requestCode) {
            case REQUEST_GOOGLE_PLAY_SERVICES:
                ...
                if(googleDriveDelegate!=null){
                    ...
                    googleDriveDelegate.playServicesOn(able);
                }
            ...
            case REQUEST_ACCOUNT_PICKER:
                ...
                if (resultCode == context.RESULT_OK && data != null &&
                    ...
                    if(googleDriveDelegate!=null){
                        googleDriveDelegate.accountSelected(accountName);
                    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        public MakeRequestTask(GoogleAccountCredential credential,int _type) {
            ...
            mService = new com.google.api.services.drive.Drive.Builder(
                    ...
                    .setApplicationName(GoogleDriveAPI.APP_NAME)
                    .build();
        }
            ...
            if (output == null || output.size() == 0) {
               // mOutputText.setText("No results returned.");
                ...
                if(googleDriveDelegate!=null){
                    switch (type){
                        case TASK_TYPE_TOKEN:
                            googleDriveDelegate.getTokenComplete(output.get(0));
                            break;
                        case TASK_TYPE_FILELIST:
