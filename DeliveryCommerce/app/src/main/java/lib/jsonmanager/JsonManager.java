...
public class JsonManager implements JsonLoaderDelegate
{
	...
	public void onCompleted(String jsonUrl,JSONObject result) { 
	    if(delegate!=null){
			delegate.onJsonCompleted(this,jsonUrl, result);
			removeLoader (jsonUrl);
		};
	} 
	public void onLoadErr(String jsonUrl) { 
		if(delegate!=null){
			delegate.onJsonLoadErr(this,jsonUrl);
			removeLoader (jsonUrl);
		};
    } 
	...
	public  interface JsonManagerDelegate {
	    void onJsonCompleted(JsonManager manager,String xml_path,JSONObject result);
	    void onJsonLoadErr(JsonManager manager,String xml_path);
