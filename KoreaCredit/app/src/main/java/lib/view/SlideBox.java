...
public class SlideBox extends FrameLayout implements AnimationListener,GestureDelegate{
    ...
    private int totalNum,currentIdx,sizeX,currentDr;
	...
	public void moveIndex(int idx){
        ...
        LayoutParams layout=new LayoutParams( sizeX,LayoutParams.MATCH_PARENT ,Gravity.LEFT|Gravity.TOP);
