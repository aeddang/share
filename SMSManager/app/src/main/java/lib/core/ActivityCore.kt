...
open class ActivityCore : AppCompatActivity(), Animation.AnimationListener, View.OnClickListener
{
    ...
    fun viewAlertSelect(title: String, msg: String, listener: DialogInterface.OnClickListener?)
    {
        ...
        {
            alert.setPositiveButton(R.string.btn_ok, DialogInterface.OnClickListener { dialogInterface, i ->{}})
            alert.setNegativeButton(R.string.btn_no, DialogInterface.OnClickListener { dialogInterface, i ->{}})
        }
