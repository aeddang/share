...
class ListSendSMSList(view: View) : RecyclerView.ViewHolder(view) , View.OnClickListener, Observer
{
    ...
    init
    {
        ...
        textDate = view.findViewById<View>(R.id._textDate) as TextView
        textDesc = view.findViewById<View>(R.id._textDesc) as TextView
        textStatus = view.findViewById<View>(R.id._textStatus) as TextView
        btnRetry = view.findViewById<View>(R.id._btnRetry) as Button
        /*
