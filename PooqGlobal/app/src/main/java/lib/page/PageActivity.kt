...
import pooq.com.pooqglobal.R


open class PageActivity<T> : AppCompatActivity(), PagePresenter.View<T>, PageFragment.Delegate
{
    ...
    open protected fun <T> getPageByID(id:T): PageFragment {return PageFragment()}
    ...
    open protected fun <T> getPopupByID(id:T): PageFragment {return PageFragment()}
